...
public class Cli {
			...
			throws IOException
	{
		...
		while (more)
		{
			...
			LocalDate Today = LocalDate.of(2024, 10, 25);
			//used for testing
			if(Today.getMonth() == Month.OCTOBER && Today.getDayOfMonth() == 31)
			{Scanner employeeToPromote = new Scanner(new File("./Employees.csv"));
			...
			if(Today.getDayOfMonth() == 25) {
				...
				line = new Scanner(new File("./Employees.csv"));
				line.nextLine();
				while(line.hasNext()) {
			...
			userFind = new Scanner(new File("./Users.csv"));
			boolean done = false;
				...
				while(hrworking == true && more == true) {
					...
					if(answer.toUpperCase().equals("P")) {
						...
						if(fpq.toUpperCase().equals("F")) {
							...
							Scanner line = new Scanner(new File("./Employees.csv"));
							line.nextLine();
							...
							System.out.println("Type the name of the person to promote.");
							String who = in.nextLine();
							Scanner line = new Scanner(new File("./PartTimeEmployees.csv"));
							line.nextLine();
							boolean foundPerson = false;
							while(line.hasNext()) {
								//finds salary
						...
						if(answer1.toUpperCase().equals("P")) {
							...
							if (0 <= n && n < choices.size()) {
								...
								if (0 <= n2 && n2 < choicesOfJt.size()) {
									...
									Scanner payScalept = new Scanner(new File("./PayScaleForPartime.csv"));
									payScalept.nextLine();
									double hourlyrate=0;
	...
	public void overwriteEmployee(FullTimeEmployee e) throws IOException {
		...
		line1 = new Scanner(new File("./Employees.csv"));
		...
		PrintWriter clear = new PrintWriter("./Employees.csv");
		clear.close();
		for(String x:temp) {
			PrintWriter writer = new PrintWriter(new FileWriter("./Employees.csv",true));
	...
	public void overwriteEmployee(PartTimeEmployee e) throws IOException {
		ArrayList<String> temp = new ArrayList<String>();
		line1 = new Scanner(new File("./PartTimeEmployees.csv"));
		temp.add(line1.nextLine());
		while(line1.hasNext()) {
			String i = line1.nextLine();
			String[] s = i.split(",");
		...
		PrintWriter clear = new PrintWriter("./PartTimeEmployees.csv");
		clear.close();
		for(String x:temp) {
			PrintWriter writer = new PrintWriter(new FileWriter("./ParttTimeEmployees.csv",true));
			writer.println(x.toUpperCase());
			writer.close();
		}
	}
	...
	public void writeToListOfUsers(String employeeInFormation,String csvlistname) throws IOException {
		//find a new line
		w = new PrintWriter(new FileWriter("./"+csvlistname+".csv",true));
	...
	public String searchEmployees(String name,String csvname) throws FileNotFoundException {
		line1 = new Scanner(new File("./"+csvname+".csv"));
		String r = "";
	...
	public String searchNotif(String name) throws FileNotFoundException {
		line1 = new Scanner(new File("./Notifs.csv"));
		String r = "";
		while(line1.hasNext()) {
			String find = line1.nextLine();
			String[] results = find.split(",");
	...
	public void createNotif(String name,String notif) throws IOException {
		//find a new line
		w=new PrintWriter(new FileWriter("./Notifs.csv",true));
	...
	public void adressedNotif(String name) throws IOException {
		...
		PrintWriter clear = new PrintWriter("./Notifs.csv");
		clear.close();
		for(String x:temp) {
			PrintWriter writer = new PrintWriter(new FileWriter("./Notifs.csv",true));
			writer.println(x.toUpperCase());
			writer.close();
		}
	}
	...
	public ArrayList<String> getChoiceSinc() throws FileNotFoundException{
		line1 = new Scanner(new File("./PayScale.csv"));
	...
	public ArrayList<String> ptgetchoicesinjc() throws FileNotFoundException{
		line1 = new Scanner(new File("./PayscaleForParTime.csv"));
		ArrayList<String> choices = new ArrayList<String>();
		while(line1.hasNext()) {
			String input=line1.nextLine();
			if(input.split(",").length == 1) {
	...
	public boolean inPayClaim(String name) throws FileNotFoundException {
		line1 = new Scanner(new File("./PayClaimSubmit.csv"));
	...
	public void submitPayClaim(String name) throws IOException {
		...
		w=new PrintWriter(new FileWriter("./PayClaimSubmit.csv",true));
	...
	public void payClaimDone(String name) throws IOException {
		...
		PrintWriter clear = new PrintWriter("./PayClaimSubmit.csv");
		clear.close();
		for(String x:temp) {
			PrintWriter writer = new PrintWriter(new FileWriter("./PayClaimSubmit.csv",true));
			writer.println(x.toUpperCase());
			writer.close();
		}
	}
	...
	public void addToPaySlip(String name,String info) throws IOException {
		...
		w=new PrintWriter(new FileWriter("./PaySlip.csv",true));
	...
	public String seePaySlip(String name, String inputDate) throws FileNotFoundException {
		line1 = new Scanner(new File("./PaySlip.csv"));
		String ret = "";
		while(line1.hasNext()) {
			String i =line1.nextLine();
			String[] s = i.split(",");
